    ...
    return (
        ...
        <Box >
            <motion.div
                ...
                animate={control}
            >
                <Grid component='section' container spacing={10} >

                    <Grid item xs={12} sx={{ width: '100%', display: 'flex', justifyContent: 'center', textAlign: 'center' }}>
                        <Box sx={{ width: '65%' }}>
                            <Typography variant="h4" color='#f58634' sx={{ fontSize: '36px', fontWeigth: 700, lineHeight: '1.3em' }}>
                    ...
                    <Grid item xs={12} sx={{ padding: '10px', display: 'flex', justifyContent: 'center' }}>
                        <Grid component='section' container spacing={0} sx={{ width: '65%' }}>
                            <Grid item xs={12} sm={12} md={2} sx={{ padding: '20px' }}>
                                <Box>
                                    <Typography variant="h3" color='#2e2e2e' sx={{ fontSize: 72, fontWeigth: 700, textAlign: 'end' }}>01</Typography>
                                </Box>
                            </Grid>
                    ...
                    <Grid item xs={12} sx={{ padding: '10px', display: 'flex', justifyContent: 'center' }}>
                        <Grid component='section' container spacing={0} sx={{ width: '65%' }}>
                            <Grid item xs={12} sm={12} md={2} sx={{ padding: '20px' }}>
                                <Box>
                                    <Typography variant="h3" color='#2e2e2e' sx={{ fontSize: 72, fontWeigth: 700, textAlign: 'end' }}>02</Typography>
                                </Box>
                            </Grid>
                            <Grid item border={1} xs={12} sm={12} md={10} sx={{
                                borderColor: 'transparent',
                    ...
                    <Grid item xs={12} sx={{ padding: '10px', display: 'flex', justifyContent: 'center' }}>
                        <Grid component='section' container spacing={0} sx={{ width: '65%' }}>
                            <Grid item xs={12} sm={12} md={2} sx={{ padding: '20px' }}>
                                <Box>
                                    <Typography variant="h3" color='#2e2e2e' sx={{ fontSize: 72, fontWeigth: 700, textAlign: 'end' }}>03</Typography>
                                </Box>
                            </Grid>
                            <Grid item border={1} xs={12} sm={12} md={10} sx={{
                                borderColor: 'transparent',
                    ...
                    <Grid item xs={12} sx={{ padding: '10px', display: 'flex', justifyContent: 'center' }}>
                        <Grid component='section' container spacing={0} sx={{ width: '65%' }}>
                            <Grid item xs={12} sm={12} md={2} sx={{ padding: '20px' }}>
                                <Box>
                                    <Typography variant="h3" color='#2e2e2e' sx={{ fontSize: 72, fontWeigth: 700, textAlign: 'end' }}>04</Typography>
                                </Box>
                            </Grid>
                            <Grid item border={1} xs={12} sm={12} md={10} sx={{
                                borderColor: 'transparent',
